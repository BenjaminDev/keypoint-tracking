...
from utils import exr2rgb, Keypoints, MetaData, exr_channel_to_np, mask_to_keypoints, mask_to_bounding_boxes, read_meta, draw_keypoints, draw_bounding_box
...
if __name__ == "__main__":
    ...
    for exr_file in args.src_dir.glob("*MAIN*.exr"):
        ...
        draw_keypoints(img, read_meta_back.keypoints, read_meta_back.keypoint_labels, read_meta_back.visible, show_all=True).save(f"{os.fsdecode(args.dst_dir)}/anno_{exr_file.stem}{args.ext}")
    breakpoint()
